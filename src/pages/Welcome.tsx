...
function ExploreCard({
  ...
  return (
    <button
      type="button"
      className={cx('group text-left rounded-lg border border-slate-700 bg-slate-800 p-4 transition', 'hover:bg-slate-700/60')}
    >
    ...
    <div className="relative">
      ...
      <div className="mt-6">
        ...
        <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <ExploreCard icon={Landmark} title="Finance" tone="purple" desc="View salary details, taxes, and finance-related actions." />
          <ExploreCard icon={Sun} title="Leaves" tone="teal" desc="Apply for leave, track balances, and check approvals." />
          <ExploreCard icon={Timer} title="Attendance" tone="sky" desc="Clock in/out, check logs, and manage attendance records." />
          <ExploreCard icon={Inbox} title="Inbox" tone="amber" desc="All requests, approvals, and updates in one place." />
          <ExploreCard icon={FileText} title="Documents" tone="emerald" desc="Access HR letters, policies, and essential documents." />
          <ExploreCard icon={Receipt} title="Expenses" tone="rose" desc="Submit expenses, track reimbursements, and approvals." />
          <ExploreCard icon={Handshake} title="Engage" tone="purple" desc="Recognize peers, celebrate milestones, and stay connected." />
          <ExploreCard icon={Building2} title="Org" tone="sky" desc="Browse org structure, roles, and reporting relationships." />
        </div>
      </div>
